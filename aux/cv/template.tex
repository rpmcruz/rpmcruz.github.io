...
@% if item.date %@@@ item.date @@, @% endif %@\textbf{@@ item.title @@}@% if item.subtitle %@\\@@ massajar(item.subtitle) @@@% endif %@

@% if item.description %@\begin{adjustwidth}{1.5em}{}\color{black!70}\footnotesize @@ massajar(item.description) @@\end{adjustwidth}@% endif %@
@% else %@
...
\vspace{0pt}\includegraphics[width=\linewidth]{imgs/@@ item.image @@}
\end{minipage}
@% endif %@
